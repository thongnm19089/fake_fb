...
const COLORS = {
    ...
    const BIG_NUMBERS = [
        {
            old: "20.338.836", // Số lượt xem CŨ (đang hiện trên màn hình)
            new: "50.338.836" // Số lượt xem MỚI
        },
        {
            old: "3.856.616",         // Số comment CŨ (đang hiện trên màn hình)
            new: "11.856.616"      // Số comment MỚI
        },
        {
            old: "179.639",         // Số comment CŨ (đang hiện trên màn hình)
            new: "579.639"      // Số comment MỚI
        },
        {
            old: "8.000.000,000",         // Số comment CŨ (đang hiện trên màn hình)
            new: "579.639"      // Số comment MỚI
        },
        {
            old: "400.000,0",         // Số comment CŨ (đang hiện trên màn hình)
            new: "8.000.000,000"      // Số comment MỚI
        },
    ];
